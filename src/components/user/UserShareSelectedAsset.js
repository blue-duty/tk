        ...
        return (
            <>
                <Row gutter={{ xs: 8, sm: 16, md: 24}}>
                    ...
                    {/*</Col>*/}
                    <Col span={18}>
                        <Text italic style={{fontSize:18,color:'#666'}}>已授权主机产列表</Text>
                        <div>
                            {
                ...
                <Content key='page-content' className="site-layout-background">
                    <div style={{marginBottom: 20}}>
                        <Row justify="space-around" align="middle" gutter={{ xs: 8, sm: 16, md: 24}}>
                            <Col span={4} key={1}>
                                <Text italic style={{fontSize:18,color:'#666'}}>全部主机列表</Text>
                            </Col>
                            <Col span={20} key={2} style={{textAlign: 'right'}}>
                                <Space>
                                    ...
                                    <Select mode="multiple"
                                            allowClear
                                            placeholder="主机标签" onChange={this.handleTagsChange}
                                            style={{minWidth: 150}}>
