                ...
                return (
                    <div>
                        ...
                        <Button type="link" size='small'
                                onClick={() => this.showModal('更新自动任务', record)}>编辑</Button>
        ...
        return (
            <>
                <Content className="site-layout-background page-content">
                    ...
                    <div>
                        <Text italic style={{fontSize:20,color:'#666'}}>自动任务</Text>
                        <Divider />
                        <Row justify="space-around" gutter={{ xs: 8, sm: 16, md: 24}} style={{margin:'0 0 10px 0'}}>
                            <Col span={14} key={1}>
                                <Form ref={this.jobFormRef} name="jobForm" layout="horizontal" labelAlign="left" onFinish={this.handleSearch}>
                                    <Form.Item
                                        {...formItemLayout}
                                        name="name"
                                        label="任务名称"
                            ...
                            <Col span={10} key={2} style={{textAlign: 'right'}}>
                                <Space>
                                    <Button type="primary"
                                            onClick={() => this.showModal('新增自动任务',{})}>新增
                                    </Button>
